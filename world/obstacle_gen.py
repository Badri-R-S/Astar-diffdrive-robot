...
def pathu():
    ...
    obs.append(pygame.draw.rect(surface, color1, pygame.Rect(250-5, 70-5, 15+10, 125+10)))
    obs.append(pygame.draw.rect(surface, color1, pygame.Rect(150-5, 5-5, 15+10, 125+10)))
...
def obs_coord(x,y):
    ...
    ind=0
    #Bounds
    if ((x<5) or (x>595)) or ((y<5) or (y>199)):
        occupied_coords.append([x,y])
        print("Kurukka Kowsik vandha 1",occupied_coords)
        ind=1
